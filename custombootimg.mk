...
$(INSTALLED_BOOTIMAGE_TARGET): $(PRODUCT_OUT)/kernel $(recovery_ramdisk) $(INSTALLED_RAMDISK_TARGET) $(PRODUCT_OUT)/utilities/busybox $(MKBOOTIMG) $(MINIGZIP) $(INTERNAL_BOOTIMAGE_FILES)
	...
	$(hide) cp -R $(PRODUCT_OUT)/../../../../device/sony/pepper/prebuilt/root/default.prop $(PRODUCT_OUT)/combinedroot/
	...
	$(hide) python $(PRODUCT_OUT)/../../../../device/sony/pepper/releasetools/mkelf.py -o $(PRODUCT_OUT)/kernel.elf $(PRODUCT_OUT)/kernel@0x00008000 $(PRODUCT_OUT)/combinedroot.fs@0x01000000,ramdisk $(PRODUCT_OUT)/../../../../device/sony/pepper/prebuilt/cmdline@cmdline
	...
	$(hide) cat $(PRODUCT_OUT)/kernel.elf.bak3 $(PRODUCT_OUT)/../../../../device/sony/pepper/prebuilt/elf.3 > $(PRODUCT_OUT)/kernel.elf.bak
